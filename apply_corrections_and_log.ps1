                            ...
                            if ($errors.Count -gt 0) {
                                ...
                                foreach ($err in $errors) {
                                    ...
                                    if ($sugs.Count -gt 0) {
                                        ...
                                        "    '$wrong' -> '$suggest'" | Out-File -FilePath $LogPath -Append -Encoding utf8
                                    } else {
                                        "    '$wrong' -> (no suggestion)" | Out-File -FilePath $LogPath -Append -Encoding utf8
                                    }
                                }
